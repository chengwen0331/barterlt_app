...
import 'package:barterlt_app/mainscreen.dart';
import 'package:barterlt_app/model/myconfig.dart';
import 'package:barterlt_app/model/user.dart';
import 'package:barterlt_app/registrationscreen.dart';
import 'package:barterlt_app/resetpassscreen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void onLogin() {
    ...
    print(pass);
    http.post(Uri.parse("${MyConfig().SERVER}barterlt_app/php/login_user.php"),
        body: {
          "email": email,
          "password": pass,
        }).then((response) {
